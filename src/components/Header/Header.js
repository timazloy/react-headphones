    ...
    <header className="header">
        ...
        <Link to="/">
          <div className="header__logo logo-section">
            <div className="logo-section__column">
              <img
                className="logo-section__img logo"
                src="/img/logo.png"
                alt="logo"
              />
            </div>
      ...
      <div className="header__column">
        <div className="personal-section">
          <button
            onClick={() => setModalBasketActive(true)}
            className="personal-section__item basket-section"
          >
            <img className="basket" src="/img/basket.svg" alt="basket" />
            <p className="basket-section__text">{totalPrice} руб.</p>
            {cartItems.length ? (
              <div className="basket-section__count counter">
                {cartItems.length}
              </div>
            ) : (
              <div className="basket-section__count basket-section__count--hide counter">
                {cartItems.length}
              </div>
            )}
          </button>
