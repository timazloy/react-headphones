          ...
          <div className="goods__item item" onClick={() => openModal(item)}>
              ...
              <div className="custom-modal__info">
                ...
                <ul className="custom-modal__list">
                  <li>
                    ...
                    <span className="custom-modal__item">
                      {dataForModal.name}
                    </span>
                  </li>
                  <li>
                  ...
                  <li>
                    <span className="custom-modal__name">
                      Страна изготовитель
                    </span>
                    <span className="custom-modal__item">
                      {dataForModal.country}
                    </span>
                  </li>
                  <li>
                    <span className="custom-modal__name">Гарантия</span>
                    <span className="custom-modal__item">
                      {dataForModal.guarantee}
                    </span>
                  </li>
                  <li>
                    <span className="custom-modal__name">Частота</span>
                    <span className="custom-modal__item">
                      {dataForModal.frequency}
                    </span>
                  </li>
                  <li>
                    <span className="custom-modal__name">Чувствительность</span>
                    <span className="custom-modal__item">
                      {dataForModal.sensitivity}
                    </span>
                  </li>
                </ul>
                <div className="custom-modal__buttons">
                  <button
                    onClick={addToFavoriteIcon}
                    type="button"
                    className={
                      favorite
                        ? "custom-modal__button active-favorite"
                        : "custom-modal__button"
                    }
                  >
                    <img
                      src={favorite ? "/img/like.svg" : "/img/btn-favorite.svg"}
                      alt="button-favorite"
                    />
                    <span>
                      {favorite ? "Добавлено" : "Добавить в избранное"}
                    </span>
                  </button>
                  <button
                    onClick={onClickPlus}
                    type="button"
                    className={
                      isItemAdded(dataForModal.parentId)
                        ? "custom-modal__button active-add"
                        : "custom-modal__button "
                    }
                  >
                    <img
            ...
            <div className="item__price item-price">
              <div className="item-price__section">
                ...
                <div className="item-price__text">
                  {price
                    .toString()
                    .replace(
                      /(\d{1,3}(?=(?:\d\d\d)+(?!\d)))/g,
