...
function Cart({ parentId, id, item, title, price, imageUrl, isLoading = true, isFavorite, addToFavorite, onPlus }) {
                     ...
                     <div className='custom-modal__info'>
                        ...
                        <div className='custom-modal__buttons'>
                           <button
                              ...
                              type='button'
                              className={favorite ? 'custom-modal__button active-favorite' : 'custom-modal__button'}
                           >
                           ...
                           <button
                              ...
                              type='button'
                              className={
                                 isItemAdded(dataForModal.parentId) ? 'custom-modal__button active-add' : 'custom-modal__button '
                              }
                           >
                              <img
                                 src={isItemAdded(dataForModal.parentId) ? '/img/Add-basket.svg' : '/img/btn-add.svg'}
                                 alt='button-favorite'
                              />
                  ...
                  <div className='item__price item-price'>
                     <div className='item-price__section'>
                        ...
                        <div className='item-price__text'>
                           {price.toString().replace(/(\d{1,3}(?=(?:\d\d\d)+(?!\d)))/g, '$1' + ' ')} руб.
                        </div>
                     </div>
